...
+(NativeBridgeTest_testBool_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    NativeBridgeTest_testBool_caller_params* par = [[[NativeBridgeTest_testBool_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
...
+(NativeBridgeTest_testInt_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    NativeBridgeTest_testInt_caller_params* par = [[[NativeBridgeTest_testInt_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
...
+(NativeBridgeTest_testFloat_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    NativeBridgeTest_testFloat_caller_params* par = [[[NativeBridgeTest_testFloat_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
...
+(NativeBridgeTest_testString_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    NativeBridgeTest_testString_caller_params* par = [[[NativeBridgeTest_testString_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
