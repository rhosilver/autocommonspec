...
+(rb_NativeBridgeTest_testBool_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    rb_NativeBridgeTest_testBool_caller_params* par = [[[rb_NativeBridgeTest_testBool_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
...
+(rb_NativeBridgeTest_testInt_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    rb_NativeBridgeTest_testInt_caller_params* par = [[[rb_NativeBridgeTest_testInt_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
...
+(rb_NativeBridgeTest_testFloat_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    rb_NativeBridgeTest_testFloat_caller_params* par = [[[rb_NativeBridgeTest_testFloat_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
...
+(rb_NativeBridgeTest_testString_caller_params*) makeParams:(NSArray*)_params _item:(id<INativeBridgeTestSingleton>)_item _methodResult:(CMethodResult*)_methodResult {
    rb_NativeBridgeTest_testString_caller_params* par = [[[rb_NativeBridgeTest_testString_caller_params alloc] init] autorelease];
    par.params = _params;
    par.item = _item;
    par.methodResult = [_methodResult retain];
    return [par retain];
